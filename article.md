...
<!-- #region tags=["introduction", "anchor-introduction"] -->
## Introduction
...
<!-- #region tags=["Section-2", "anchor-Section-2"] -->
...
<!-- #region tags=["Section-3", "anchor-Section-3"] -->
...
<!-- #region tags=["Section-4", "anchor-Section-4"] -->
...
```python tags=["figure-3", "anchor-figure-3"]
from IPython.display import Image, display
...
<!-- #region tags=["Section-5", "anchor-Section-5"] -->
...
<!-- #region tags=["Section-6", "anchor-Section-6"] -->
...
<!-- #region jdh={"object": {"source": ["table 1: Average dust produced and filters installed per technique and year, adapted from Schueneman, 1963"]}} tags=["table-1", "anchor-table-1"] -->
...
<!-- #region tags=["Section-7", "hermeneutics", "anchor-Section-7"] -->
## Data visualisation
...
```python tags=["figure-9", "hermeneutics", "anchor-figure-9"]
from IPython.display import Image, display
...
```python jdh={"object": {"source": ["figures 10 a and b from left to right: (a) English and French version of the map, (b) German version of the map."], "type": "image"}} tags=["figure-10", "hermeneutics", "anchor-figure-10"]
from IPython.display import display
from PIL import Image
import matplotlib.pyplot as plt
import numpy as np
...
```python tags=["figure-12", "hermeneutics", "anchor-figure-12"]
from IPython.display import Image, display
...
<!-- #region tags=["Section-8", "anchor-Section-8"] -->
## Final analysis
...
<!-- #region tags=["Section-8-1", "anchor-Section-8-2"] -->
...
<!-- #region tags=["Section-8-3", "anchor-Section-8-3"] -->
...
<!-- #region tags=["Section-8-4", "anchor-Section-8-4"] -->
...
<!-- #region tags=["Section-9", "anchor-Section-9"] -->
## Conclusion
